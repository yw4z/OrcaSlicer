...
public:
    ...
    wxBoxSizer *create_item_label(wxString title, wxString tooltip);
    ...
    wxBoxSizer *create_item_input(wxString title, wxString secondary_title, wxString tooltip, std::string param, std::function<void(wxString)> onchange = {});
    ...
    wxBoxSizer *create_item_draco(wxString title, wxString tooltip);
